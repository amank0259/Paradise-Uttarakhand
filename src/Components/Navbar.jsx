    ...
    return (
        <>
            <div className='bg-zinc-200 text-black h-20 flex items-center justify-between md:px-32 lg:48 px-10'>
                ...
                {nav && (
                    <ul className='flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-slate-800 to-slate-900 text-gray-300'>
