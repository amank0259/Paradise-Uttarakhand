            ...
            <div className="py-2 flex-col w-full md:flex-row lg:pt-10">
                <div className="-m-1 flex flex-col md:flex-row w-full flex-wrap md:-m-2">
                    <div data-aos="fade-right" data-aos-offset="200" data-aos-duration='500' data-aos-delay="100" className="flex md:w-1/2 flex-wrap">
                        ...
                        <div onClick={() => navigate(`/destinations/${kedarnathName}`)} className="w-full sm:w-1/2 p-1 md:p-2 relative h-[40vh]">
                            <LazyLoadImage
                                alt={kedarnathName}
                                className="block h-full w-full rounded-lg object-cover object-center duration-300 shadow-md hover:shadow-md hover:shadow-yellow-500 cursor-pointer"
                                src={kedarnathImg} />
                        ...
                        <div onClick={() => navigate(`/destinations/${auliName}`)} className="w-full relative p-1 md:p-2">
                            <LazyLoadImage
                                alt={auliName}
                                className="block h-full w-full rounded-lg object-cover object-center duration-300 shadow-md hover:shadow-md hover:shadow-yellow-500 cursor-pointer"
                                src={auliImg} />
                    ...
                    <div data-aos="fade-left" data-aos-offset="200" data-aos-duration='500' data-aos-delay="100" className="flex md:w-1/2 flex-wrap">
                        ...
                        <div onClick={() => navigate(`/destinations/${mussoorieName}`)} className="w-full sm:w-1/2 p-1 md:p-2 relative h-[40vh]">
                            <LazyLoadImage
                                alt={mussoorieName}
                                className="block h-full w-full rounded-lg object-cover object-center duration-300 shadow-md hover:shadow-md hover:shadow-yellow-500 cursor-pointer"
                                src={mussoorieImg} />
                        ...
                        <div onClick={() => navigate(`/destinations/${choptaName}`)} className="w-full sm:w-1/2 p-1 md:p-2 relative h-[40vh]">
                            <LazyLoadImage
                                alt={choptaName}
                                className="block h-full w-full rounded-lg object-cover object-center duration-300 shadow-md hover:shadow-md hover:shadow-yellow-500 cursor-pointer"
                                src={choptaImg} />
